...
import 'package:flutter_ui_components/src/core/utils/platform_util.dart';
import 'package:flutter_ui_components/src/core/utils/json_utils.dart';
...
void main() {
  ...
  group('PlatformUtil', () {
    test('platform checks do not throw', () {
      // Just verifying they can be called without errors in test environment
