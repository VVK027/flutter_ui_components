...
/// Manages application-level translations and placeholder replacement.
class Translations {
  final Map<String, String> _map;

  Translations(this._map);

  /// Translates a [key] and replaces placeholders with provided [args] or [namedArgs].
  ///
...
/// A static cache for managing loaded translation maps.
class TranslationCache {
  static final Map<String, Map<String, String>> _cache = {};

  /// Preload all supported locales concurrently from 'assets/translations/{locale}.arb'.
